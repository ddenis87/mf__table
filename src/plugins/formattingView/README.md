...
### Examples
```javascript
formattingView('text')// 'text'
formattingView(35, { valueType: 'number', formatString: 'positive=true$minFD=2' })// '+35,00'
formattingView('2021-04-01', { valueType: 'date', formatString: 'd=numeric$m=numeric$y=2-digit' })// '01.04.21'
```
